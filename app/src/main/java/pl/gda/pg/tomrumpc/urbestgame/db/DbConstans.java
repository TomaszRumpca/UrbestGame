...
public class DbConstans {
    ...
    public static final String KEY_ACHIVED_POINTS = "achivedPoints";
    public static final String ACHIVED_POINTS_OPTION = "INTEGER";
    ...
    public static final String LATLNG_OPTION = "TEXT NOT NULL";

    public static final String KEY_STATE = "State";
    public static final String STATE_OPTION = "INTEGER NOT NULL";

    public static final String KEY_DATE_OF_ACTIVATION = "dateOfActovation";
    ...
    public static final String CREATE_TASKS_TABLE = "create table "
            + TASKS_TABLE + " (" + KEY_TASK_ID + " " + TASK_ID_OPTION + ", "
            + KEY_TASK + " " + TASK_OPTION + ", " + KEY_MAX_POINTS + " "
            + MAX_POINTS_OPTION + ", " + KEY_ACHIVED_POINTS + " "
            + ACHIVED_POINTS_OPTION + ", " + KEY_USED_PROMPTS + " "
            + USED_PROMPTS_OPTION + ", " + KEY_TASK_GROUP + " " + TASK_GROUP_OPTION
            + ", " + KEY_LATLNG + " " + LATLNG_OPTION + ", " + KEY_STATE
            + " " + STATE_OPTION + ", " + KEY_DATE_OF_ACTIVATION + " "
            + DATE_OF_ACTIVATION_OPTION + ", " + KEY_DATE_OF_COMPLETION + " "
            + DATE_OF_COMPLETION_OPTION + ");";
    ...
    public static final String CREATE_MARKERS_TABLE = "create table "
    ...
    public static final String CREATE_ALERTS_TABLE = "create table "
            + ALERTS_TABLE + " (" + KEY_ALERT_ID + " " + ALERT_ID_OPTION
    ...
    public static final String CREATE_TASK_GROUPS_TABLE = "create table "
            + TASK_GROUPS_TABLE + " (" + KEY_GROUP_ID + " " + GROUP_ID_OPTION
